...
var _mainHeader = require('./components/main-header');

var _mainHeader2 = _interopRequireDefault(_mainHeader);

var _mainNavigation = require('./components/main-navigation');

var _mainNavigation2 = _interopRequireDefault(_mainNavigation);

var _projectsFilter = require('./components/projects-filter');

var _projectsFilter2 = _interopRequireDefault(_projectsFilter);

var _aspectRatioPreserver = require('./modules/aspect-ratio-preserver');

var _aspectRatioPreserver2 = _interopRequireDefault(_aspectRatioPreserver);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var app = function app() {
    (0, _init2.default)(_mainHeader2.default, document.querySelector('.main-header'));
    (0, _init2.default)(_mainNavigation2.default, document.querySelector('.main-navigation'));

    (0, _factory2.default)(_projectsFilter2.default, document.querySelectorAll('.projects-filter'));
...
},{"./components/main-header":299,"./components/main-navigation":300,"./components/projects-filter":301,"./factory":302,"./init":303,"./modules/aspect-ratio-preserver":304,"babel-polyfill":1}],299:[function(require,module,exports){
'use strict';

Object.defineProperty(exports, "__esModule", {
    value: true
});
var mainHeader = function mainHeader(container) {
    loadImage();
    centerHeaderContent();
...
var mainNavigation = function mainNavigation(container) {
    var trigger_Button = document.querySelector('.main-navigation-trigger');
    var overlay = document.querySelector('.main-navigation-overlay');
    ...
    window.addEventListener('scroll', function () {
        var scrolledDistance = document.querySelector('body').scrollTop;
    ...
    function highlightSelected() {
        var id = document.querySelector('.page-content').id;
...
var _getUrlParameterValue = require('../modules/get-url-parameter-value');

var _getUrlParameterValue2 = _interopRequireDefault(_getUrlParameterValue);
...
var projectsFilter = function projectsFilter(container) {
    var filterableGrids = document.querySelectorAll('.basic-grid.filterable');
    var filter_Buttons = document.querySelectorAll('.projects-filter .filter');

    Array.from(filter_Buttons).forEach(function (button) {
    ...
    var urlFilter = (0, _getUrlParameterValue2.default)('filter');
    ...
    function filter(type) {
        Array.from(filterableGrids).forEach(function (grid) {
            if (type !== 'all') {
...
},{"../factory":302,"../modules/aspect-ratio-preserver":304,"../modules/get-url-parameter-value":305}],302:[function(require,module,exports){
"use strict";
...
function factory(fn, containers) {
...
var aspectRatioPreserver = function aspectRatioPreserver(container) {
    ...
    function setAspectRatio() {
        ...
        if (window.innerWidth < 680 && aspectRatioMobile) container.style.height = Math.round(width / ratiosMobileObj.x * ratiosMobileObj.y) + 'px';else if (aspectRatio) container.style.height = Math.round(width / ratiosObj.x * ratiosObj.y) + 'px';
    }
};
...
var getUrlParameterValue = function getUrlParameterValue(key) {
...
exports.default = getUrlParameterValue;
